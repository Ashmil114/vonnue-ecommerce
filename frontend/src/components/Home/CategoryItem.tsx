...
const CategoryItem = (props: categoryItem) => {
  ...
  return (
    <div className="min-h-[180px] mr-[20px]">
      <div
        className={`flex items-center flex-wrap justify-center relative text-center rounded-[10px] pt-[20px] pb-[18px] border-[1px] border-[#F4F6FA]  hover:border-primary-bg  min-w-[150px]`}
